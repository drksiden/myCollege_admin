 ...
 * @param subjectData Object containing subject details (name, description, hoursPerSemester, type).
...
export const createSubject = async (
  ...
  const docRef = await addDoc(collection(db, 'subjects'), dataWithTimestamps);
  return docRef.id;
};
 ...
 * @param updates Partial data of Subject to update (name, description, hoursPerSemester, type).
