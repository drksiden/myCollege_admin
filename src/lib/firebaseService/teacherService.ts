 ...
 * @param profileData Object containing userId and other teacher-specific fields.
...
export const createTeacherProfile = async (
  db: Firestore,
  profileData: Omit<Teacher, 'id' | 'createdAt' | 'updatedAt'>
): Promise<string> => {
  ...
  await setDoc(teacherRef, dataWithTimestamps);
