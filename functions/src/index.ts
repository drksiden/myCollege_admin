import * // или const functions = require("firebase-functions");
as functions from "firebase-functions";
import * // или const admin = require("firebase-admin");
 ...
 */
export const createGroup = regionalFunctions.https.onCall(async (data, context) => {
...
// Другие функции (получение списка групп, обновление, удаление и т.д.)
// будут похожи по структуре.